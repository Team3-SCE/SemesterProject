...
void Add_Packages()
{
	string destenation, origin, departure_date, return_date, hotel, flight_company, flight_number, vacant_spots, price;
	system("CLS");
	cout << "\n\n\n\t\t\tEnter destenation\n\n\t\t\t";
	cin >> destenation;
	cout << "\n\n\n\t\t\tEnter origin\n\n\t\t\t";
	...
	DB_packages <<endl<< destenation << " " << origin << " " << departure_date << " " << return_date << " " << hotel << " " << flight_company << " " << flight_number << " " << vacant_spots << " " << price << "\n";
	DB_packages << "~~------------------------------------------------------------------------------------~~" << endl;
